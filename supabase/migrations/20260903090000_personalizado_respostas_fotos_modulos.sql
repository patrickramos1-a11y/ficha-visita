-- Evolui atendimentos personalizados para respostas semânticas e fotos vinculadas a múltiplos itens.
...
-- Classificação inicial da ficha "Inspeção PCA - Posto Av. Brasil".
-- As regras são textuais e idempotentes para não depender de IDs fixos entre ambientes.
